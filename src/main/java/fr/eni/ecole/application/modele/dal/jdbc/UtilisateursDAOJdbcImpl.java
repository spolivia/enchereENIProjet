...
public class UtilisateursDAOJdbcImpl implements UtilisateursDAO {
	...
	public void insert(Utilisateurs user) throws DALException {
		...
		try (Connection connection = JdbcTools.getConnection();
			...
			statement.executeUpdate();
			System.out.println("verification addUser");
		} catch (SQLException e) {
	...
	public void updateUtilisateurProfile(Utilisateurs user) throws DALException {
		String sql = "UPDATE UTILISATEURS " + "SET nom = ?, prenom = ?, email = ?, telephone = ?, "
				+ "rue = ?, code_postal = ?, ville = ? " + "WHERE no_utilisateur = ?";
		Connection connection = null;
	...
	public Utilisateurs selectByArticle(int articleId) throws DALException {
		String sql = "SELECT u.* " + "FROM UTILISATEURS u "
				+ "INNER JOIN ARTICLES_VENDUS a ON u.no_utilisateur = a.no_utilisateur " + "WHERE a.no_article = ?";
